...
enum MoroWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: MoroWebStatus) -> Bool {
        switch (self, other) {
...
extension MoroWebStatus {
    static func == (lhs: MoroWebStatus, rhs: MoroWebStatus) -> Bool {

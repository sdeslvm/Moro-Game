...
protocol WebLoadable: AnyObject {
    var state: MoroWebStatus { get set }
...
final class MoroWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

    @Published var state: MoroWebStatus = .standby
...
extension MoroWebLoader: WKNavigationDelegate {

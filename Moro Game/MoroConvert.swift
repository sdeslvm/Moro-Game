...
struct MoroGameInitialView: View {
    private var gameResourceURL: URL { URL(string: "https://moroplayz.top/load")! }

    var body: some View {
        ZStack {
            Color(hex: "#000")
                .ignoresSafeArea()
            MoroEntryScreen(loader: .init(resourceURL: gameResourceURL))
        }
    }
}

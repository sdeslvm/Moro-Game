...
struct MoroWebViewBox: UIViewRepresentable {
    // MARK: - Свойства

    @ObservedObject var loader: MoroWebLoader

    // MARK: - Координатор

    func makeCoordinator() -> MoroWebCoordinator {
        MoroWebCoordinator { [weak loader] status in
